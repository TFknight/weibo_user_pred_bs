...
class user_predict:
    ...
    def train_lsi_model(self,doc):
        ...
        #训练模型
        model_dm = Doc2Vec(X_doc,dm=1, size=300, negative=5, hs=0, min_count=1, window=30,sample=1e-5,workers=8,alpha=0.025,min_alpha=0.025)
    ...
    def get_regre_score(self,result_list):
        ...
        result = sum_fenzi/(result_list.__len__())
        return result

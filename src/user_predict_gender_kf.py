...
# ------------------------------begin to predict------------
    ...
    X_sp_train,X_train_tag = prepare_tfidf("gender_train.csv")
    X_sp_test,X_test_tag = prepare_tfidf("gender_test.csv")
    X_sp_valid ,X_valid_tag= prepare_tfidf("gender_valid.csv")
...
# # -----------------------ka fang ------------------------------------
    ...
    best_parameters = mygridsearch(X_new_valid, y_valid, clf, param_grid)

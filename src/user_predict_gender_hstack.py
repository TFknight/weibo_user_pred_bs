...
class user_predict:
    ...
    def train_lsi_model(self,doc):
        ...
        joblib.dump(model_dm,"model_d2v_hstack_dm.model")
        joblib.dump(model_dbow,"model_d2v_hstack_dbow.model")
        print "d2w模型训练完成"
    ...
    def train_lsi(self,doc):
        ...
        if(os.path.exists("model_d2v_hstack_dm.model")):

            #load train model
            model_dm = joblib.load("model_d2v_hstack_dm.model")
            model_dbow = joblib.load("model_d2v_hstack_dbow.model")
        else:
            #load train model
